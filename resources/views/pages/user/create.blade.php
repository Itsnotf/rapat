                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input value="{{ old('NoHandphone') }}" type="text" class="form-control @error('NoHandphone') is-invalid @enderror" name="NoHandphone" id="NoHandphone" placeholder="No Handphone">
                                    @error('NoHandphone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
