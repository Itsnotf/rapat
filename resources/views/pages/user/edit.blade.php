                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="NoHandphone" class="col-sm-3 col-form-label">Nohandphone</label>
                                <div class="col-sm-9">
                                    <input value="{{ old('NoHandphone', $item->NoHandphone) }}" type="text" class="form-control @error('NoHandphone') is-invalid @enderror" name="NoHandphone" id="NoHandphone" placeholder="NoHandphone">
                                    @error('NoHandphone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
